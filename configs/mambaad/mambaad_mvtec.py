...
class cfg(cfg_common, cfg_dataset_default, cfg_model_mambaad):
	...
	def __init__(self):
		...
		self.data.root = '/home/jjquan/Ader-test/t0/data/mvtec'
		...
		self.model_s = dict(
			depths_decoder=[3, 9, 9, 7],#3, 6, 6, 3 [98.7- 3,7,7,6]
			scan_type='hilbert',
			num_direction=8,
		)
		self.model = Namespace()
		self.model.name = 'mambaad'
		self.model.kwargs = dict(pretrained=False, checkpoint_path='/home/jjquan/Ader-test/q_and_kv_on_visa/runs/MAMBAADTrainer_configs_mambaad_mambaad_visa_20241125-223411/net_420.pth', strict=True, model_t=self.model_t,
